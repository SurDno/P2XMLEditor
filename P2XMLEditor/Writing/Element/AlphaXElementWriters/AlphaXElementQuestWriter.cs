...
public class AlphaXElementQuestWriter : IAlphaXElementWriter<Quest> {
	public XElement ToXml(Quest element, WriterSettings settings) {
		...
		if (element.StartEvent != null)
			obj.Add(new XElement("StartEvent", element.StartEvent.Id));
