...
public class FastestParsingExecutor : ParsingExecutor {
    ...
    protected internal override IParser<RawConditionData> ConditionLoader => new RawPointerConditionLoader();
    ...
    protected internal override IParser<RawParameterData> ParameterLoader => new RawPointerParameterLoader();
    ...
    protected internal override IParser<RawSampleData> SampleLoader => new SimdSampleLoader();
