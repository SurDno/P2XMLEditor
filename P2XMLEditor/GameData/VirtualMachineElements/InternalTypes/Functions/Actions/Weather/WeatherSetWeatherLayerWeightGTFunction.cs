...
[Function("Weather.SetWeatherLayerWeightGT")]
public class WeatherSetWeatherLayerWeightGTFunction(
	VirtualMachine vm,
	string[] parameters)
	: VmFunction {
	...
	public FunctionSourceParam<GameTime>? Duration { get; } = FunctionSourceParam<GameTime>.Read(parameters[2], vm);
