...
[Function("Speaking.AddInitialPhrase")]
public class SpeakingAddInitialPhraseFunction : VmFunction {
	...
	public SpeakingAddInitialPhraseFunction(VirtualMachine vm, string[] parameters) {
