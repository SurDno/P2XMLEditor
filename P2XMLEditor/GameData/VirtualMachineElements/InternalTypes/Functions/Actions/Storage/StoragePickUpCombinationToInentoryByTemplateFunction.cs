...
[Function("Storage.PickUpCombinationToInentoryByTemplate")]
public class StoragePickUpCombinationToInentoryByTemplateFunction(
	VirtualMachine vm,
	string[] parameters)
	: VmFunction {
	...
	public override List<string>? GetParamStrings() => [CombinationObject.Write(), ContainerTemplate.Write()];
}
